using WasteOrganisations.Example.Endpoints;
using WasteOrganisations.Example.Services;
using WasteOrganisations.Utils;
using WasteOrganisations.Utils.Http;
using WasteOrganisations.Utils.Mongo;
using FluentValidation;
using System.Diagnostics.CodeAnalysis;
using WasteOrganisations.Config;
using WasteOrganisations.Utils.Logging;
using Serilog;
